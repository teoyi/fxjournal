...
router.route('/')
    .get(verifyRoles(ROLES_LIST.User), journalEntryController.getAllEntriesByUserAndJournal)
router.route('/getEntries')
    .get(verifyRoles(ROLES_LIST.User), journalEntryController.getEntryByEntry)
