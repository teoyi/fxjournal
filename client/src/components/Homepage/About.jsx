...
const About = () => {
    return (
        <div className="h-4/6 w-full flex flex-row items-center justify-center bg-banana text-black10 py-10" id="about">
            ...
            <div className="lg:max-w-screen-lg 2xl:max-w-screen-2xl w-full flex flex-row justify-center items-center">
                {/* <div className="flex flex-col justify-center items-center text-black10 m-10 text-center">
                ...
                <div className="w-1/3">
                    ...
                    <button className="bg-black10 text-banana px-10 py-2 rounded-full">
                        <Link to="/register" className="text-xl font-semibold">Sign Up</Link>
                    </button>
                </div>
                <div className="w-2/3 flex lg:flex-col 2xl:flex-row ">
                    <div className="flex w-full lg:flex-row 2xl:flex-col lg:justify-start lg:items-center text-black10 p-10">
