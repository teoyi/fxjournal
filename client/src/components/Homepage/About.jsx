...
const About = () => {
  return (
        <div className="h-4/6 w-full flex flex-row items-center justify-center bg-black text-banana" id="about">
            ...
            <div className="lg:max-w-screen-lg 2xl:max-w-screen-2xl w-full flex flex-row justify-center items-center">
                ...
                <div className="w-1/3">
                    ...
                    <p>Take a look at what fxjournal has to offer and decide for yourself if it would be the right tool to take your trading journey to another level! </p>
                </div>
                <div className="w-2/3 flex lg:flex-col 2xl:flex-row ">
                    <div className="flex w-full lg:flex-row 2xl:flex-col lg:justify-start lg:items-center text-banana m-10">
                        ...
                        <div className="flex flex-col justify-start w-full items-start lg:ml-20p 2xl:ml-0 2xl:text-center">
                            <h1 className="my-3 text-l text-center w-full font-semibold uppercase">forex currencies</h1>
                    ...
                    <div className="flex w-full lg:flex-row 2xl:flex-col lg:justify-start lg:items-center text-banana m-10">
                        ...
                        <div className="flex flex-col justify-start w-full items-start lg:ml-20p 2xl:ml-0 2xl:text-center">
                            <h1 className="my-3 text-l text-center w-full font-semibold uppercase">Journalling</h1>
                    ...
                    <div className="flex w-full lg:flex-row 2xl:flex-col lg:justify-start lg:items-center text-banana m-10">
                        ...
                        <div className="flex flex-col justify-start w-full items-start lg:ml-20p 2xl:ml-0 2xl:text-center">
                            <h1 className="my-3 text-l text-center w-full font-semibold uppercase">Ongoing news</h1>
